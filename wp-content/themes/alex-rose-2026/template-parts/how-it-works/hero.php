...
<section class="hiw-hero">
	<img class="hiw-hero__img" src="<?php echo esc_url(alex_rose_2026_uploads_url('2026/07/process-cutting.webp')); ?>" alt="" aria-hidden="true" loading="eager" width="1920" height="900">
