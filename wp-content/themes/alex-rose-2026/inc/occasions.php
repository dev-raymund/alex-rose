...
function alex_rose_2026_occasions(): array {
	...
	$cache = array(
		...
		'evening' => array(
			'title'           => __('Evening & Statement Jackets', 'alex-rose-2026'),
			'short_title'     => __('Evening & Statement', 'alex-rose-2026'),
			'eyebrow'         => __('Made-to-Measure Jackets · Alex Rose', 'alex-rose-2026'),
			'hero_image'      => alex_rose_2026_uploads_url('2026/05/cloth-riviera.jpg'),
			'hero_lead'       => __('A jacket designed to be noticed, and remembered.', 'alex-rose-2026'),
			'related_kicker'  => __('Events · Occasions · Celebrations', 'alex-rose-2026'),
			'when_kicker'     => __('The Occasion', 'alex-rose-2026'),
			'when_title'      => __('When to wear it.', 'alex-rose-2026'),
			'when_paragraph'  => __('There are moments in life that deserve something more deliberate. A wedding, a milestone birthday, a charity dinner, a night at the opera. These are occasions where a jacket is the point, where the cloth and the cut do real work, and where the difference between wearing something made for you and something bought off the peg becomes impossible to ignore.', 'alex-rose-2026'),
			'when_bullets'    => array(
				__('Weddings as a guest or groomsman', 'alex-rose-2026'),
				__('Award ceremonies and galas', 'alex-rose-2026'),
				__('Theatre and opera evenings', 'alex-rose-2026'),
				__('Significant birthdays and celebrations', 'alex-rose-2026'),
				__('Milestone personal occasions', 'alex-rose-2026'),
			),
			'samples_title'   => __('Made in this cloth and occasion.', 'alex-rose-2026'),
			'samples'         => array(
			...
			'cloths'          => array(
				array(
					'slug'   => 'english-blazer',
					'name'   => __('The English Blazer Collection', 'alex-rose-2026'),
					'kicker' => __('Rich, structured, deeply formal', 'alex-rose-2026'),
					'price'  => __('From £595', 'alex-rose-2026'),
					'image'  => alex_rose_2026_uploads_url('2026/05/cloth-english-blazer.jpg'),
				),
				array(
					...
					'kicker' => __('Characterful, distinctive, memorable', 'alex-rose-2026'),
					'price'  => __('From £625', 'alex-rose-2026'),
					'image'  => alex_rose_2026_uploads_url('2026/05/cloth-tweed.webp'),
				),
			),
			'thinking_title'    => __('How we think about this jacket.', 'alex-rose-2026'),
			'thinking_paragraphs' => array(
				__('An evening jacket is one of the few pieces where we actively encourage our customers to be bolder than they think they want to be. The temptation is always to play it safe. In practice, the people who choose a rich navy with a contrast lining, or a heritage tweed with a statement button, are always the ones who feel most like themselves by the end of the evening.', 'alex-rose-2026'),
				__('The lining is where an evening jacket earns its character. On a plain dark cloth, a lining in deep burgundy or forest green gives the jacket a private quality, noticed only by you and the people closest to you when you take it off. We offer a full range of lining colours and we always encourage customers to use them.', 'alex-rose-2026'),
				__('We also offer a monogram option for jackets made for weddings and significant occasions. Initials on the inside breast pocket, in a font and thread colour chosen by you. It is a small addition that turns a jacket into something that lasts beyond the occasion itself.', 'alex-rose-2026'),
			),
			'pull_quote'     => __('The right jacket for an evening is one you are still thinking about the next morning.', 'alex-rose-2026'),
			'cta_title'      => __('Design your evening jacket.', 'alex-rose-2026'),
			'cta_lead'       => __('Tell us your occasion and we will guide you through the cloth, the cut, and every detail in between.', 'alex-rose-2026'),
		),
